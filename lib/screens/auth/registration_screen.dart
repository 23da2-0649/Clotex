...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void _signUp() async {
    ...
    final error = await AuthService().signUpWithEmailPassword(name, email, password);
        ...
        child: Column(
          ...
          children: [
            ...
            FadeInDown(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Join the world of quiet luxury.',
            ...
            FadeInUp(
              ...
              child: Column(
                children: [
                  _buildTextField(context, 'FULL NAME', 'Your Name', controller: _nameController),
